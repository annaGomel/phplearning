...
//18.	Создайте папку dir, в папке этой создайте три файла с расширение .txt, один файл с расширением .html. Выведите на экран список только файлов с расширением .txt.
//19.	В папке из предыдущей задачи выведите количество файлов с с расширением .html и с расширением .txt.
//20.	Создайте страницу профиля, в котором можно загружать аватарку, должны быть поля Имя, почта, логин, номер телефона, информация о себе. Кнопка сохранить. Информацию хранить в файле *.
