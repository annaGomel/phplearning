        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                if(isset($_POST['store'])) {
                    ...
                    $sql_create = "INSERT INTO categories(name,description,code) VALUES ('{$name}', '{$description}', '{$code}')";
                ...
                if(isset($_GET['update'])) {
                    ...
                    $result_one_cat = mysqli_query($connectionTechnomart, $sql_one_cat);
                ...
                if(isset($_POST['save'])) {
                    ...
                    $update_sql = "UPDATE categories SET name='{$name}', description='{$description}', code='{$code}' WHERE id = $id";
