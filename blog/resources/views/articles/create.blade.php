<div class="main-content">
  <article>
    ...
    <div class="form-body">
      {{ Form::open(['method' => 'POST','route' => ['articles.store'],'style'=>'form-horizontal']) }}
        {{ csrf_field() }}

        <div class="form-group">
          <label for="title">{{ __('site.inp_article_title') }}</label>
          {{ Form::text('title', old('title'), ['class'=>'form-control', 'placeholder'=>__('site.inp_article_title_placeholder') ]) }}
        </div>

        <div class="form-group">
          <label for="text">{{ __('site.inp_article_text') }}</label>
          {{ Form::textarea('text', old('text'), ['class'=>'form-control', 'placeholder'=> __('site.inp_article_text_placeholder') ]) }}
        </div>
